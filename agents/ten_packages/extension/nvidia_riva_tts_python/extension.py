...
class NvidiaRivaTTSExtension(AsyncTTS2BaseExtension):
    ...
    def synthesize_audio_sample_rate(self) -> int:
        ...
        return self.config.params.get("sample_rate", 16000) if self.config else 16000
    ...
    async def cancel_tts(self) -> None:
        ...
        self.ten_env.log_info(f"cancel_tts current_request_id: {self.current_request_id}")
    ...
    async def _handle_completed_request(self, reason: TTSAudioEndReason) -> None:
        ...
        # Finish request
        await self.finish_request(request_id=self.current_request_id, reason=reason)
